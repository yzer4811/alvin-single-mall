...
import com.alvin.mall.modules.ums.dto.UmsAdminLoginParam;
...
import com.alvin.mall.modules.ums.model.UmsRole;
...
public class UmsAdminController {
    ...
    public CommonResult login(@Validated @RequestBody UmsAdminLoginParam umsAdminLoginParam) {
        ...
        Map<String, UmsAdmin> map = new HashMap<>();
        map.put(session.getId(), login);
        mySession.setCookie(session.getId(), login);
